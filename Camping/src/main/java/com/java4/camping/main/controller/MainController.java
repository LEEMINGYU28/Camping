package com.java4.camping.main.controller;
...
public class MainController {
	...
	@RequestMapping(value = "/main/view/{id}", method = RequestMethod.GET)
	public String mainViewNotice(Model model, @PathVariable("id") int id) {
