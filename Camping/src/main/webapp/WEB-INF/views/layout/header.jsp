...
<link href="<%= contextPath %>/resources/styles/layout/join.css" rel="stylesheet" />
...
<link href="<%= contextPath %>/resources/styles/layout/header.css" rel="stylesheet" />
</head>
<body>

	<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
		<img src="<%= contextPath %>/resources/img/categorys/campingLogo3.jpg" alt="Campfire Icon">
		<a class="navbar-brand" href="<%= contextPath %>/index">Camp</a>
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown" onmouseover="showDropdown()"
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
						id="dropdownMenu">
						<a class="dropdown-item" href="<%= contextPath %>/announcement/1">공지사항</a> <a
							class="dropdown-item" href="<%= contextPath %>/review">이용후기</a>
					</div></li>
				<li class="nav-item"><a class="nav-link" href="<%= contextPath %>/fee">이용요금</a></li>
				<li class="nav-item"><a class="nav-link" href="<%= contextPath %>/reserve">캠핑장예약</a></li>
